  ...
  useEffect(() => {
    ...
    if (acceptedPrivacyPolicyVersion !== privacyPolicyVersion) {
      Swal.fire({
        ...
        html: 'Our Privacy Policy has been updated. Please review and accept it from <a href="https://github.com/sayborduu/privgpt/blob/main/privacy%20policy.md" target="_blank" style="color:#000">this link</a>.',
        icon: 'info',
